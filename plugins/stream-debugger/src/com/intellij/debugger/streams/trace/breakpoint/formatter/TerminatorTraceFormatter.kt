...
class TerminatorTraceFormatter(private val valueManager: ValueManager, private val collectedValues: StreamTraceValues) : PeekTraceFormatter(valueManager) {
  /**
  ...
  private fun formatTime(time: ObjectReference): Value = valueManager.watch {
